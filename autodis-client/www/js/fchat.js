FCHAT = {
  ...
  Init: function (serverip, serverport) {
    //alert('InitApp serverip: ' + serverip);
    var client = feathers();
    var serveraddr = 'http://' + serverip + ':' + serverport;
    const isocket = io(serveraddr);
    // Create the Feathers application with a `socketio` connection
    client.configure(feathers.socketio(isocket));
